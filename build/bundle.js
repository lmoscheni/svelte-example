...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 7, 8, 245);
    			attr_dev(input1, "class", "h-6 w-6 self-center bg-slate-50 accent-green-500");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$2, 8, 8, 412);
    			attr_dev(div0, "class", "flex flex-row justify-between");
    			add_location(div0, file$2, 6, 4, 193);
    			...
    			add_location(textarea, file$2, 10, 4, 538);
    			...
    			add_location(button0, file$2, 11, 4, 701);
    			...
    			add_location(button1, file$2, 12, 4, 937);
    			...
    			add_location(button2, file$2, 18, 4, 1223);
    			attr_dev(div1, "class", "w-full sm:3/5 md:w-2/5 xl:w-1/4 p-5 bg-neutral-200 rounded-lg shadow-md");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			p = element("p");
    			t5 = text("Complete the fields, only the title is ");
    			...
    			add_location(strong, file$1, 22, 57, 1222);
    			...
    			add_location(label0, file$1, 26, 16, 1371);
    			attr_dev(input, "class", "w-full h-9 mb-3 px-1 rounded-md");
    			add_location(input, file$1, 27, 16, 1452);
    			attr_dev(label1, "class", "text-sm font-semibold uppercase");
    			add_location(label1, file$1, 28, 16, 1537);
    			attr_dev(textarea, "class", "w-full h-28 p-1 rounded-md");
    			add_location(textarea, file$1, 29, 16, 1616);
    			attr_dev(div2, "class", "w-full py-5 flex flex-row flex-wrap");
    			add_location(div2, file$1, 25, 14, 1305);
    			...
    			attr_dev(button0, "class", "m-0 px-3 py-1 rounded-md shadow-sm border-2 border-green-600 text-sm font-semibold text-white bg-green-600 hover:bg-inherit hover:text-green-600 disabled:bg-gray-500 disabled:text-white disabled:cursor-not-allowed disabled:border-gray-500");
    			add_location(button0, file$1, 35, 10, 1860);
    			attr_dev(button1, "class", "m-0 px-3 py-1 rounded-md shadow-sm border-2 border-gray-500 text-sm font-semibold hover:bg-gray-500 hover:text-white");
    			add_location(button1, file$1, 42, 10, 2308);
    			attr_dev(div6, "class", "bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-3");
    			add_location(div6, file$1, 34, 8, 1773);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 22, 1, 642);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 23, 14, 727);
    			add_location(p, file, 23, 1, 714);
    			attr_dev(h2, "class", "py-5 text-3xl font-semibold");
    			add_location(h2, file, 25, 1, 826);
    			attr_dev(button, "class", "w-full sm:3/5 md:w-2/5 xl:w-1/4 border-none bg-neutral-200 text-black text-[5em] text-bold shadow-md");
    			add_location(button, file, 35, 2, 1236);
    			attr_dev(div0, "class", "w-full py-5 flex flex-row flex-wrap gap-5 justify-center");
    			add_location(div0, file, 31, 1, 1055);
    			attr_dev(div1, "class", "pb-10");
    			add_location(div1, file, 21, 0, 621);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const createTodo = payload => {
    		$$invalidate(0, todos = [...todos, Object.assign({ id: v4(), checked: false }, payload)]);
    	};
