...
<div class="w-full sm:3/5 md:w-2/5 xl:w-1/4 p-5 bg-blue-100 rounded-lg shadow-md">
    <div class="flex flex-row justify-between">
        ...
        <input class="h-6 w-6 self-center bg-slate-50 accent-green-600" bind:checked={item.checked} type="checkbox" />
    </div>
